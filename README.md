...
* **Dynamic "Open Now" Logic**: Utilizing Python’s `datetime` module to compare system clocks against restaurant operating hours for live status indicators.
* **Database Integration**: Refactoring the data layer to support a SQL database (SQLite/PostgreSQL) for better scalability over static JSON.
